...
type Bill struct {
	...
	// 厂商
	// @gotags: json:"vendor"
	Vendor resource.Vendor `protobuf:"varint,1,opt,name=vendor,proto3,enum=ahwhy.yCmdb.resource.Vendor" json:"vendor,omitempty"`
	// 账单的月份
	// @gotags: json:"month"
	...
	ProductDetail string `protobuf:"bytes,7,opt,name=product_detail,json=productDetail,proto3" json:"product_detail,omitempty"`
	// 计费方式，比如：月95，日均峰值
	// @gotags: json:"pay_mode"
	PayMode string `protobuf:"bytes,8,opt,name=pay_mode,json=payMode,proto3" json:"pay_mode,omitempty"`
	// 计费方式详情  云服务器ECS-按量付费
	// @gotags: json:"pay_mode_detail"
	PayModeDetail string `protobuf:"bytes,9,opt,name=pay_mode_detail,json=payModeDetail,proto3" json:"pay_mode_detail,omitempty"`
	// 订单/账单ID
	...
	PrivateIp string `protobuf:"bytes,14,opt,name=private_ip,json=privateIp,proto3" json:"private_ip,omitempty"`
	// 实例配置信息
	// @gotags: json:"instance_config"
	InstanceConfig string `protobuf:"bytes,15,opt,name=instance_config,json=instanceConfig,proto3" json:"instance_config,omitempty"`
	// 地域Id
	...
	RegionName string `protobuf:"bytes,17,opt,name=region_name,json=regionName,proto3" json:"region_name,omitempty"`
	// 官网价
	// @gotags: json:"sale_price"
	SalePrice float64 `protobuf:"fixed64,18,opt,name=sale_price,json=salePrice,proto3" json:"sale_price,omitempty"`
	// 优惠金额
	// @gotags: json:"save_cost"
	SaveCost float64 `protobuf:"fixed64,19,opt,name=save_cost,json=saveCost,proto3" json:"save_cost,omitempty"`
	// 应付金额
	// @gotags: json:"real_cost"
	RealCost float64 `protobuf:"fixed64,20,opt,name=real_cost,json=realCost,proto3" json:"real_cost,omitempty"`
	// 信用额度支付金额
	// @gotags: json:"credit_pay"
	CreditPay float64 `protobuf:"fixed64,21,opt,name=credit_pay,json=creditPay,proto3" json:"credit_pay,omitempty"`
	// 代金券抵扣
	...
	CashPay float64 `protobuf:"fixed64,23,opt,name=cash_pay,json=cashPay,proto3" json:"cash_pay,omitempty"`
	// 储值卡抵扣
	// @gotags: json:"storedcard_pay"
	StoredcardPay float64 `protobuf:"fixed64,24,opt,name=storedcard_pay,json=storedcardPay,proto3" json:"storedcard_pay,omitempty"`
	// 欠费金额
	// @gotags: json:"outstanding_amount"
	OutstandingAmount float64 `protobuf:"fixed64,25,opt,name=outstanding_amount,json=outstandingAmount,proto3" json:"outstanding_amount,omitempty"`
...
type BillSet struct {
	...
	// 具体条目
	// @gotags: json:"items"
	Items []*Bill `protobuf:"bytes,2,rep,name=items,proto3" json:"items,omitempty"`
}
...
type QueryBillRequest struct {
	...
	// 厂商
	// @gotags: json:"vendor"
	Vendor resource.Vendor `protobuf:"varint,2,opt,name=vendor,proto3,enum=ahwhy.yCmdb.resource.Vendor" json:"vendor,omitempty"`
	// 账单的月份
	// @gotags: json:"month"
...
func (x *QueryBillRequest) Reset() {
	*x = QueryBillRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_app_bill_pb_bill_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*QueryBillRequest) Descriptor() ([]byte, []int) {
	return file_app_bill_pb_bill_proto_rawDescGZIP(), []int{3}
}

func (x *QueryBillRequest) GetPage() *PageRequest {
	if x != nil {
		return x.Page
	}
	return nil
...
var file_app_bill_pb_bill_proto_rawDesc = []byte{
	...
	0x75, 0x72, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc1, 0x07, 0x0a, 0x04, 0x42,
	0x69, 0x6c, 0x6c, 0x12, 0x34, 0x0a, 0x06, 0x76, 0x65, 0x6e, 0x64, 0x6f, 0x72, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x61, 0x68, 0x77, 0x68, 0x79, 0x2e, 0x79, 0x43, 0x6d, 0x64,
	0x62, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x56, 0x65, 0x6e, 0x64, 0x6f,
	0x72, 0x52, 0x06, 0x76, 0x65, 0x6e, 0x64, 0x6f, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x6d, 0x6f, 0x6e,
	...
	0x6f, 0x77, 0x6e, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x70, 0x72, 0x6f,
	...
	0x6c, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74,
	0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x12, 0x19, 0x0a, 0x08, 0x70, 0x61, 0x79, 0x5f, 0x6d, 0x6f,
	0x64, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x70, 0x61, 0x79, 0x4d, 0x6f, 0x64,
	0x65, 0x12, 0x26, 0x0a, 0x0f, 0x70, 0x61, 0x79, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x5f, 0x64, 0x65,
	0x74, 0x61, 0x69, 0x6c, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x70, 0x61, 0x79, 0x4d,
	0x6f, 0x64, 0x65, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x12, 0x19, 0x0a, 0x08, 0x6f, 0x72, 0x64,
	...
	,
	...
	,
	...
	0x0a, 0x07, 0x42, 0x69, 0x6c, 0x6c, 0x53, 0x65, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x74,
	...
	0x6c, 0x2e, 0x42, 0x69, 0x6c, 0x6c, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x63, 0x0a,
	...
	0x65, 0x74, 0x22, 0x95, 0x02, 0x0a, 0x10, 0x51, 0x75, 0x65, 0x72, 0x79, 0x42, 0x69, 0x6c, 0x6c,
	...
	0x6d, 0x64, 0x62, 0x2e, 0x62, 0x69, 0x6c, 0x6c, 0x2e, 0x50, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x52, 0x04, 0x70, 0x61, 0x67, 0x65, 0x12, 0x34, 0x0a, 0x06, 0x76, 0x65,
	0x6e, 0x64, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x61, 0x68, 0x77,
	...
	0x05, 0x6d, 0x6f, 0x6e, 0x74, 0x68, 0x12, 0x1d, 0x0a, 0x0a, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	0x74, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x61, 0x63, 0x63, 0x6f,
	0x75, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x72, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x5f,
	...
	,
	...
	0x2f, 0x61, 0x68, 0x77, 0x68, 0x79, 0x2f, 0x79, 0x43, 0x6d, 0x64, 0x62, 0x2f, 0x61, 0x70, 0x70,
...
var file_app_bill_pb_bill_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_app_bill_pb_bill_proto_goTypes = []interface{}{
	(*Bill)(nil),             // 0: ahwhy.yCmdb.bill.Bill
	(*BillSet)(nil),          // 1: ahwhy.yCmdb.bill.BillSet
	(*PageRequest)(nil),      // 2: ahwhy.yCmdb.bill.PageRequest
	(*QueryBillRequest)(nil), // 3: ahwhy.yCmdb.bill.QueryBillRequest
	nil,                      // 4: ahwhy.yCmdb.bill.Bill.ExtraEntry
	(resource.Vendor)(0),     // 5: ahwhy.yCmdb.resource.Vendor
}
var file_app_bill_pb_bill_proto_depIdxs = []int32{
	5, // 0: ahwhy.yCmdb.bill.Bill.vendor:type_name -> ahwhy.yCmdb.resource.Vendor
	4, // 1: ahwhy.yCmdb.bill.Bill.extra:type_name -> ahwhy.yCmdb.bill.Bill.ExtraEntry
	0, // 2: ahwhy.yCmdb.bill.BillSet.items:type_name -> ahwhy.yCmdb.bill.Bill
	2, // 3: ahwhy.yCmdb.bill.QueryBillRequest.page:type_name -> ahwhy.yCmdb.bill.PageRequest
	5, // 4: ahwhy.yCmdb.bill.QueryBillRequest.vendor:type_name -> ahwhy.yCmdb.resource.Vendor
	0, // 5: ahwhy.yCmdb.bill.Service.SaveBill:input_type -> ahwhy.yCmdb.bill.Bill
	3, // 6: ahwhy.yCmdb.bill.Service.QueryBill:input_type -> ahwhy.yCmdb.bill.QueryBillRequest
	0, // 7: ahwhy.yCmdb.bill.Service.SaveBill:output_type -> ahwhy.yCmdb.bill.Bill
	1, // 8: ahwhy.yCmdb.bill.Service.QueryBill:output_type -> ahwhy.yCmdb.bill.BillSet
...
func file_app_bill_pb_bill_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_app_bill_pb_bill_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
