...
func (c *serviceClient) SaveOSS(ctx context.Context, in *OSS, opts ...grpc.CallOption) (*OSS, error) {
	out := new(OSS)
	err := c.cc.Invoke(ctx, "/ahwhy.yCmdb.oss.Service/SaveOSS", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Service_SaveOSS_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ahwhy.yCmdb.oss.Service/SaveOSS",
	}
...
func _Service_QueryOSS_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ahwhy.yCmdb.oss.Service/QueryOSS",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Service_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ahwhy.yCmdb.oss.Service",
