...
func (c *serviceClient) SaveSLB(ctx context.Context, in *SLB, opts ...grpc.CallOption) (*SLB, error) {
	out := new(SLB)
	err := c.cc.Invoke(ctx, "/ahwhy.yCmdb.slb.Service/SaveSLB", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Service_SaveSLB_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ahwhy.yCmdb.slb.Service/SaveSLB",
	}
...
func _Service_QuerySLB_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ahwhy.yCmdb.slb.Service/QuerySLB",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Service_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ahwhy.yCmdb.slb.Service",
