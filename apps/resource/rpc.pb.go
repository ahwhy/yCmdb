...
type DeleteResponse struct {
	...
	DeleteRecords []*DeleteRecord `protobuf:"bytes,1,rep,name=delete_records,json=deleteRecords,proto3" json:"delete_records,omitempty"`
	// 删除失败统计
...
type SearchRequest struct {
	...
	UsageMode *USAGE_MODE `protobuf:"varint,5,opt,name=usage_mode,json=usageMode,proto3,enum=ahwhy.yCmdb.resource.USAGE_MODE,oneof" json:"usage_mode,omitempty"`
	// 厂商
	// @gotags: json:"vendor"
	Vendor *VENDOR `protobuf:"varint,6,opt,name=vendor,proto3,enum=ahwhy.yCmdb.resource.VENDOR,oneof" json:"vendor,omitempty"`
	// 资源所属账号
	// @gotags: json:"owner"
	Owner string `protobuf:"bytes,7,opt,name=owner,proto3" json:"owner,omitempty"`
	// 资源类型
	// @gotags: json:"type"
	Type *TYPE `protobuf:"varint,8,opt,name=type,proto3,enum=ahwhy.yCmdb.resource.TYPE,oneof" json:"type,omitempty"`
	// 服务商中的状态
	// @gotags: json:"status"
	...
	RelationDeep int32 `protobuf:"varint,12,opt,name=relation_deep,json=relationDeep,proto3" json:"relation_deep,omitempty"`
	// 关键字参数
...
func (x *SearchRequest) GetPage() *page.PageRequest {
	if x != nil {
		return x.Page
	}
	return nil
...
type TagSelector struct {
	...
	// 匹配符
	// @gotags: json:"opertor"
	Opertor string `protobuf:"bytes,2,opt,name=opertor,proto3" json:"opertor,omitempty"`
	// 匹配的值
	// @gotags: json:"values"
...
var file_apps_resource_pb_rpc_proto_rawDesc = []byte{
	...
	0x70, 0x62, 0x2f, 0x72, 0x70, 0x63, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x14, 0x61, 0x68,
	0x77, 0x68, 0x79, 0x2e, 0x79, 0x43, 0x6d, 0x64, 0x62, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x1a, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x69,
	...
	0x74, 0x6f, 0x1a, 0x1f, 0x61, 0x70, 0x70, 0x73, 0x2f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x2f, 0x70, 0x62, 0x2f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x22, 0x32, 0x0a, 0x0d, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x52, 0x65, 0x71,
	...
	0x75, 0x72, 0x63, 0x65, 0x49, 0x64, 0x73, 0x22, 0xa3, 0x01, 0x0a, 0x0e, 0x44, 0x65, 0x6c, 0x65,
	0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x49, 0x0a, 0x0e, 0x64, 0x65,
	0x6c, 0x65, 0x74, 0x65, 0x5f, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x18, 0x01, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x22, 0x2e, 0x61, 0x68, 0x77, 0x68, 0x79, 0x2e, 0x79, 0x43, 0x6d, 0x64, 0x62,
	...
	0x63, 0x6f, 0x72, 0x64, 0x73, 0x12, 0x21, 0x0a, 0x0c, 0x66, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x5f,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b, 0x66, 0x61, 0x69,
	0x6c, 0x65, 0x64, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x23, 0x0a, 0x0d, 0x73, 0x75, 0x63, 0x63,
	0x65, 0x73, 0x73, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x0c, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x6c, 0x0a,
	0x0c, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x12, 0x0e, 0x0a,
	...
	0x08, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x75, 0x63,
	0x63, 0x65, 0x73, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63,
	0x65, 0x73, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x22, 0xab, 0x04, 0x0a, 0x0d,
	...
	0x6e, 0x76, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x65, 0x6e, 0x76, 0x12, 0x44, 0x0a,
	0x0a, 0x75, 0x73, 0x61, 0x67, 0x65, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x20, 0x2e, 0x61, 0x68, 0x77, 0x68, 0x79, 0x2e, 0x79, 0x43, 0x6d, 0x64, 0x62, 0x2e,
	0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x55, 0x53, 0x41, 0x47, 0x45, 0x5f, 0x4d,
	0x4f, 0x44, 0x45, 0x48, 0x00, 0x52, 0x09, 0x75, 0x73, 0x61, 0x67, 0x65, 0x4d, 0x6f, 0x64, 0x65,
	...
	0x77, 0x6e, 0x65, 0x72, 0x12, 0x33, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x08, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x61, 0x68, 0x77, 0x68, 0x79, 0x2e, 0x79, 0x43, 0x6d, 0x64, 0x62,
	0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x54, 0x59, 0x50, 0x45, 0x48, 0x02,
	...
	0x73, 0x12, 0x35, 0x0a, 0x04, 0x74, 0x61, 0x67, 0x73, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x21, 0x2e, 0x61, 0x68, 0x77, 0x68, 0x79, 0x2e, 0x79, 0x43, 0x6d, 0x64, 0x62, 0x2e, 0x72, 0x65,
	...
	,
...
var file_apps_resource_pb_rpc_proto_goTypes = []interface{}{
	(*DeleteRequest)(nil),    // 0: ahwhy.yCmdb.resource.DeleteRequest
	(*DeleteResponse)(nil),   // 1: ahwhy.yCmdb.resource.DeleteResponse
	(*DeleteRecord)(nil),     // 2: ahwhy.yCmdb.resource.DeleteRecord
	(*SearchRequest)(nil),    // 3: ahwhy.yCmdb.resource.SearchRequest
	(*TagSelector)(nil),      // 4: ahwhy.yCmdb.resource.TagSelector
	(*page.PageRequest)(nil), // 5: infraboard.mcube.page.PageRequest
	(USAGE_MODE)(0),          // 6: ahwhy.yCmdb.resource.USAGE_MODE
	(VENDOR)(0),              // 7: ahwhy.yCmdb.resource.VENDOR
	(TYPE)(0),                // 8: ahwhy.yCmdb.resource.TYPE
	(*ResourceSet)(nil),      // 9: ahwhy.yCmdb.resource.ResourceSet
}
var file_apps_resource_pb_rpc_proto_depIdxs = []int32{
	2, // 0: ahwhy.yCmdb.resource.DeleteResponse.delete_records:type_name -> ahwhy.yCmdb.resource.DeleteRecord
	5, // 1: ahwhy.yCmdb.resource.SearchRequest.page:type_name -> infraboard.mcube.page.PageRequest
	6, // 2: ahwhy.yCmdb.resource.SearchRequest.usage_mode:type_name -> ahwhy.yCmdb.resource.USAGE_MODE
	7, // 3: ahwhy.yCmdb.resource.SearchRequest.vendor:type_name -> ahwhy.yCmdb.resource.VENDOR
	8, // 4: ahwhy.yCmdb.resource.SearchRequest.type:type_name -> ahwhy.yCmdb.resource.TYPE
	4, // 5: ahwhy.yCmdb.resource.SearchRequest.tags:type_name -> ahwhy.yCmdb.resource.TagSelector
	3, // 6: ahwhy.yCmdb.resource.RPC.Search:input_type -> ahwhy.yCmdb.resource.SearchRequest
	9, // 7: ahwhy.yCmdb.resource.RPC.Search:output_type -> ahwhy.yCmdb.resource.ResourceSet
