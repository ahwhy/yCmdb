...
func (c *serviceClient) SaveDisk(ctx context.Context, in *Disk, opts ...grpc.CallOption) (*Disk, error) {
	out := new(Disk)
	err := c.cc.Invoke(ctx, "/ahwhy.yCmdb.disk.Service/SaveDisk", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) QueryDisk(ctx context.Context, in *QueryDiskRequest, opts ...grpc.CallOption) (*DiskSet, error) {
	out := new(DiskSet)
	err := c.cc.Invoke(ctx, "/ahwhy.yCmdb.disk.Service/QueryDisk", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Service_SaveDisk_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ahwhy.yCmdb.disk.Service/SaveDisk",
	}
...
func _Service_QueryDisk_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ahwhy.yCmdb.disk.Service/QueryDisk",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Service_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ahwhy.yCmdb.disk.Service",
	...
	Metadata: "app/disk/pb/disk.proto",
}
