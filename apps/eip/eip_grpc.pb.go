...
func (c *serviceClient) SaveEIP(ctx context.Context, in *EIP, opts ...grpc.CallOption) (*EIP, error) {
	out := new(EIP)
	err := c.cc.Invoke(ctx, "/ahwhy.yCmdb.eip.Service/SaveEIP", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Service_SaveEIP_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ahwhy.yCmdb.eip.Service/SaveEIP",
	}
...
func _Service_QueryEIP_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ahwhy.yCmdb.eip.Service/QueryEIP",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Service_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ahwhy.yCmdb.eip.Service",
