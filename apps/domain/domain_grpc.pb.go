...
func (c *serviceClient) SaveDomain(ctx context.Context, in *Domain, opts ...grpc.CallOption) (*Domain, error) {
	out := new(Domain)
	err := c.cc.Invoke(ctx, "/ahwhy.yCmdb.domain.Service/SaveDomain", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Service_SaveDomain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ahwhy.yCmdb.domain.Service/SaveDomain",
	}
...
func _Service_QueryDomain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ahwhy.yCmdb.domain.Service/QueryDomain",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Service_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ahwhy.yCmdb.domain.Service",
	...
	Metadata: "app/domain/pb/domain.proto",
}
